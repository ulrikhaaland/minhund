...
class MapPageController extends BaseController {
            ...
            Padding(
              ...
              child: Text(
                _getDistance(
                    ...
                    fromLong: locationData.longitude,
                    toLatLng: latLng),
                style: ServiceProvider
  ...
  String _getDistance(
      {double fromLat, double fromLong, latlong.LatLng toLatLng}) {
    int distance = latlong.Distance()
        .distance(latlong.LatLng(fromLat, fromLong), toLatLng)
        .truncate();
    String distText = "";
    if (distance > 1000) {
      distText = (distance / 1000).truncate().toString() + " km unna";
    } else {
      distText = distance.toString() + " meter unna";
    }
    return distText;
  }
}
